...
<body data-spy="scroll" data-target=".navbar" data-offset="10" id="rests">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto"> 
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp\#about">Despre</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp\#service">Serviciile noastre</a>
                    </li>
                </ul> 
            </div>
        </div>
    ...
    <header class="header">
        <div class="overlay">
            <h1 class="title"> Logare cont curier</h1>
        </div>  
    </header>
    <!-- End Of Page Header --> 
    <!-- Start login -->
    <div class="input-form">
        <div class="form">
            <form action = LoginCurierServlet method = post>
                ...
                <input class="form-input" type="password" id="lname" name="password">
                <input class="btn btn-primary btn-sm" id="login-bttn" type = submit value = Logare>
          </form>
        </div>        
    </div>
    <!-- End login-->
