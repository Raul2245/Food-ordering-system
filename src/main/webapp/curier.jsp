...
<body data-spy="scroll" data-target=".navbar" data-offset="10" id="rests">
    ...
    <header class="header">
        <div class="overlay">
            <h1 class="title"> Lista comenzi nelivrate</h1>
        </div>  
    </header>
    <!-- End Of Page Header --> 
    ...
    <div class="restaurant-list-view">
    	<% 
    		...
    		ResultSet rs = (ResultSet)request.getSession().getAttribute("delivery");
    		if (rs != null) {
    			while (rs.next()) {
    				id++;
    				...
    				out.println("<form action = DeliveryHandlerServlet method = post>");
        			...
        			out.println("<input type = \"submit\" class=\"btn btn-primary btn-sm\" name = \"" + "accepta" + id + "\" value = \"Accepta\")>");
        			out.println("</form>");
