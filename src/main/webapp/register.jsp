...
<body data-spy="scroll" data-target=".navbar" data-offset="10" id="rests">
    ...
    <header class="header">
        <div class="overlay">
            <h1 class="title"> Inregistrare cont nou</h1>
        </div>  
    </header>
    <!-- End Of Page Header --> 
    <!-- Start register -->
    <div class="input-form">
        <div class="form">
            <form action = RegisterServlet method = post>
                ...
                <input class="form-input" type="text" name="nume">
                ...
                <input class="form-input" type="text" name="adresa">
                
                <input class="btn btn-primary btn-sm" id="login-bttn" type = submit value = Inregistrare>
          </form>
        </div> 
    </div>
    <!-- End register -->
