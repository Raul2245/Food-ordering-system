...
<body data-spy="scroll" data-target=".navbar" data-offset="10" id="rests">
    ...
    <header class="header">
        <div class="overlay">
            <h1 class="title"> Inregistrare restaurant</h1>
        </div>  
    </header>
    <!-- End Of Page Header --> 
    <!-- Start register -->
    <div class="input-form">
        <div class="form">
            <form action = PictureUploadServlet method = post enctype="multipart/form-data">
                <label class="form-label" for="restaurant-name">Nume restaurant:</label><br>
                <input class="form-input" type="text" id="fname" name="nume"><br>
                <label class="form-label" for="descriere">Adresa:</label><br>
                <input class="form-input" type="text" id="lname" name="descriere"><br>
                <label class="form-label" for="poza">Logo:</label><br>
