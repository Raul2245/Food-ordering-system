...
<body data-spy="scroll" data-target=".navbar" data-offset="10" id="rests">
    ...
    <header class="header">
        <div class="overlay">
            <h1 class="title"> Lista restaurante</h1>
        </div>  
    </header>
    <!-- End Of Page Header --> 
    ...
    <div class="restaurant-list-view">
    	<% 
    		int id = 0;
    		int selection = 0;
    		ResultSet rs = (ResultSet)request.getAttribute("restaurante");
    		while (rs.next()) {
    			id++;
    			out.println("<div class=\"restaurant-list-element\">");
    			out.println("<div class=\"restaurant-image-div\">");
    			...
    			out.println("<input type = \"hidden\" name = \"" + "restaurant" + id + "\" value = \"" + rs.getInt("id") +"\">");
    			out.println("<input type = \"submit\" class=\"btn btn-primary btn-sm\" name = \"" + "buton" + id + "\" value = \"Comanda\">");
    			out.println("</form>");
    			out.println("</div> </div>");
    		}
    	%>
