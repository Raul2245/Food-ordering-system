...
<body data-spy="scroll" data-target=".navbar" data-offset="10" id="rests">
    ...
    <div class="restaurant-list-view">
    	<% 
    		...
    		ResultSet rs = (ResultSet)request.getSession().getAttribute("prepared");
    		if (rs != null) {
    			while (rs.next()) {
        			id++;
        			out.println("<div class=\"restaurant-list-element\">");
        			out.println("<div class=\"restaurant-details\">");
        			out.println("<form action = PreparedOrdersServlet method = post>");
        			...
        			out.println("<input type = \"hidden\"  name = \"actiune"+ id + "\" value = \"" + cbll.getPreparedOrders(rs.getInt("id")) +  "\")>");
        			
            		out.println("<input type = \"submit\" class=\"btn btn-primary btn-sm\" name = \"livreaza-" + "order" + id + "\" value = \"Preparata\")>");
